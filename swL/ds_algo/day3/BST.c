...
int deleteNode(BST* bp, int data) {
  ...
  node_t* parent = search_parent(bp, data);
  ...
  } else if (((delete_node->left_child == NULL) && (delete_node->right_child != NULL)) || (delete_node->right_child == NULL) && (delete_node->left_child != NULL)) {
